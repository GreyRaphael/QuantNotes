...
- [Websocket](#websocket)
  ...
  - [python websocket client with callback](#python-websocket-client-with-callback)
...
## python websocket client with callback

`websockets` library not support callback, so use another library: `pip install websocket-client`
...
if __name__ == "__main__":
    ...
    ws = websocket.WebSocketApp("ws://localhost:8888/ws_echo", on_open=on_open, on_message=on_message, on_error=on_error, on_close=on_close)
